...
class SprdSign(object):
  ...
  def __init__(self, options, single_key):
    ...
    self.cfgfile = os.getenv("SPRD_SECURE_BOOT_SIGN_CONFIG", "vendor/projects/secure_boot_tools/key.txt") # changed for security boot by fangjun.xu
  ...
  def DoSign(self, sign_type, source_img, secure_img, mount_point):
    ...
    if part_sign_info.sign_key_name:
      ...
      print "Debug , sign key.product_name :", key.product_name
    ...
    if part_sign_info.save_key_name:
      ...
      print "Debug , save key.product_name :", key.product_name
