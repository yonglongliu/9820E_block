...
class ErrorCode(object):
  ...
  SYSTEM_VERIFICATION_FAILURE = 3100
  SYSTEM_UPDATE_FAILURE = 3101
  SYSTEM_UNEXPECTED_CONTENTS = 3102
  SYSTEM_NONZERO_CONTENTS = 3103
  SYSTEM_RECOVER_FAILURE = 3104
  VENDOR_VERIFICATION_FAILURE = 3200
  VENDOR_UPDATE_FAILURE = 3201
  VENDOR_UNEXPECTED_CONTENTS = 3202
  VENDOR_NONZERO_CONTENTS = 3203
  VENDOR_RECOVER_FAILURE = 3204
  OEM_PROP_MISMATCH = 3300
  FINGERPRINT_MISMATCH = 3301
  THUMBPRINT_MISMATCH = 3302
  OLDER_BUILD = 3303
  DEVICE_MISMATCH = 3304
  BAD_PATCH_FILE = 3305
  INSUFFICIENT_CACHE_SPACE = 3306
  TUNE_PARTITION_FAILURE = 3307
  APPLY_PATCH_FAILURE = 3308
  BUILDTYPE_MISMATCH = 3309
