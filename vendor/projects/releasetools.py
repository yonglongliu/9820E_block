...
def IncrementalOTA_InstallBegin(info):
  ...
  print "Debug : configs : " , configs
  
  for config in configs:
    if (OPTIONS.uboot_update and config.update_type == "B") or (OPTIONS.modem_update and config.update_type == "M"):
      print "Debug : OPTIONS.uboot_update " ,OPTIONS.uboot_update
      print "Debug : config.update_type " ,config.update_type
      print "Debug : config.nv_merge " ,config.nv_merge
      print "Debug : config.spl_merge " ,config.spl_merge
